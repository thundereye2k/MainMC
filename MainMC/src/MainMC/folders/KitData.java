	...
	public void onCreate() {
		...
		if (!file.exists()) {
			try {
				...
				kit.set("Kits.test.helmet", "310 protection:1 name:&7Pro&6Helmet");
				kit.set("Kits.test.chestplate", "311 protection:1 name:&7Pro&6Chestplate");
				kit.set("Kits.test.leggings", "312 protection:1 name:&7Pro&6Leggings");
				kit.set("Kits.test.boots", "313 protection:1 name:&7Pro&6Boots");
				kit.set("Kits.test.inventory", "");
				List<String> invlist = kit.getStringList("Kits.test.inventory");
				invlist.add("276 1 sharpness:3 name:&7Pro&6Sword");
				invlist.add("322:1 32");
				...
				invlist.add("272 1 durability:1");
				invlist.add("274 1");
				invlist.add("275 1");
				invlist.add("273 1");
				invlist.add("297 8");
				...
				kit.set("Kits.nothing00.chestplate", "299 durability:1");
				kit.set("Kits.nothing00.leggings", "300 durability:1");
				kit.set("Kits.nothing00.boots", "301 durability:1");
