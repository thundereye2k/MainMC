...
public class InteractEvent implements Listener {
	...
	public void onInteract(PlayerInteractEvent e) {
		...
		// BLACKLIST
		if (e.getAction().equals(Action.RIGHT_CLICK_BLOCK) && e.getClickedBlock()!=null && config.getInteractBlackList().contains("" + e.getClickedBlock().getTypeId())
		...
		if (sign.isSell() && s.hasPermission("main.sign.sell.use") || sign.isSell() && s.hasPermission("main.sign.*")) {
			eco.setMoneyValue(sign.getPrice(true) * sign.getItem().getAmount());
